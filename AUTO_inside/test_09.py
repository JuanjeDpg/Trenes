...
## Acción 2 -> Seleccionar MAG -> En bombardier hay que especificar AN o AI
if "invertida" in estadoPre:
    boton2 = "AN"
else:
    boton2 = "AI"
acciones.clicar(aguja, "MAG", boton2)
...
# Aqui no podemos usar la linea de comandos así que solo usamos el ratón
acciones.desplegarMenu(aguja) 
menu = acciones.comprobarMenu("AGnormal")
acciones.clicar(aguja, "MAG", "AN")
time.sleep(1)
rechazado = acciones.comprobarRechazo()

acciones.desplegarMenu(aguja) 
menu = acciones.comprobarMenu("AGnormal")
acciones.clicar(aguja, "MAG", "AI")
time.sleep(1)
rechazado = acciones.comprobarRechazo()
...
# Comentado porque no hay mando por defecto ni menu de ayuda
# ## Escenario 6. Aguja ---------------------------------------
...
if len(sys.argv) > 2:
    ...
    if (escenario1 and escenario2 and escenario5):
        # Nos saltamos el escenario 3 y 4 porque aun no sabemos ocupar en Bombardier
